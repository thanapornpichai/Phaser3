...
import { sendChat, sendEnterUser, sendRemoveUser, sendUserData, UserData, sendPrivateChat} from "./packet";
...
export class User
{
  ...
  {
      sendChat(this.remote, senderId, `${sender}[${senderId}]`, message);
  }
  ...
  public doPrivateChat(fromUserId: number, message: string)
  {
     this.sendChat(fromUserId, `[${fromUserId}]`, message);
  }
